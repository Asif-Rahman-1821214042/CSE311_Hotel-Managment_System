						...
						<table>
							<thead>
								<tr class="row100 head">
									...
									<th class="cell100 column3">Phn_Number</th>
									<th class="cell100 column4">Adult</th>
									<th class="cell100 column5">Children</th>
									<th class="cell100 column6">Room</th>
									<th class="cell100 column7">Bedding</th>
									<th class="cell100 column8">C_In</th>
									<th class="cell100 column9">C_Out</th>
									<th class="cell100 column10">Delect</th>
						...
						<table>
							<tbody id="myTable">
								<tr class="row100 body">
									...
									<td class="cell100 column3">'.$row["phn_number"].'</td>
									<td class="cell100 column4">'.$row["adult"].'</td>
									<td class="cell100 column5">'.$row["children"].'</td>
									<td class="cell100 column6">'.$row["Room"].'</td>
									<td class="cell100 column7">'.$row["bedding"].'</td>
									<td class="cell100 column8">'.$row["cin"].'</td>
									<td class="cell100 column9">'.$row["cout"].'</td>
									<td class="cell100 column10"><a href=delect_reservation.php?id='.$row['rsv_id'].'>Delect</a></td>
