...
<nav class="navbar navbar-default">
  ...
  <div class="navbar-header">
    <a href="edit_g_pro.php"><img src="images/default-user.png" class="img-responsive img-circle margin" style="display:inline" alt="Bird" width="50" height="50"></a>
    </div>
    <div class="navbar-header">
...
<div class="container-fluid bg-3 text-center">    
  ...
  <div class="row">
    <div class="col-sm-4">
      <p>We have all facilities to make our guest happy.</p>
      <img src="images/gst1.jpg" class="img-responsive margin" style="width:100%" alt="Image">
    </div>
    <div class="col-sm-4"> 
      <p>We have best rooms for our guest.</p>
      <img src="images/gst2.jpg" class="img-responsive margin" style="width:100%" alt="Image">
    </div>
    <div class="col-sm-4"> 
      <p>We serve delicious food for our customer.</p>
      <img src="images/gst3.jpg" class="img-responsive margin" style="width:100%" alt="Image">
    </div>
  </div>
</div>
